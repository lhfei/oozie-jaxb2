...
public class LAUNCHER {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "memory.mb", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "vcores", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "java-opts", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "env", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "queue", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "sharelib", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "view-acl", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "modify-acl", type = JAXBElement.class, required = false)
    })
