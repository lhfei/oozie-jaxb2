...
public class LAUNCHER {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "memory.mb", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "vcores", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "java-opts", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "env", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "queue", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "sharelib", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "view-acl", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "modify-acl", namespace = "uri:oozie:hive2-action:1.0", type = JAXBElement.class, required = false)
    })
