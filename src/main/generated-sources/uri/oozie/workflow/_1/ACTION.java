 ...
 *       &lt;sequence&gt;
 *         &lt;choice&gt;
 *           &lt;element name="map-reduce" type="{uri:oozie:workflow:1.0}MAP-REDUCE"/&gt;
 *           &lt;element name="pig" type="{uri:oozie:workflow:1.0}PIG"/&gt;
 *           &lt;element name="sub-workflow" type="{uri:oozie:workflow:1.0}SUB-WORKFLOW"/&gt;
 *           &lt;element name="fs" type="{uri:oozie:workflow:1.0}FS"/&gt;
 *           &lt;element name="java" type="{uri:oozie:workflow:1.0}JAVA"/&gt;
 *         &lt;/choice&gt;
 *         &lt;element name="ok" type="{uri:oozie:workflow:1.0}ACTION_TRANSITION"/&gt;
 *         &lt;element name="error" type="{uri:oozie:workflow:1.0}ACTION_TRANSITION"/&gt;
